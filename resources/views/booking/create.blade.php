...
@section('content')
    ...
    <form enctype="multipart/form-data" action="{{route("booking.store")}}" method="post">
        @if($errors->any())
        ...
        <div class="form-group row p-5">
            <div class="col-md">
                ...
                <input type="date" name="{{\App\Models\Booking::CHECK_IN}}" id="{{\App\Models\Booking::CHECK_IN}}" required class="form-control">
            </div>
        </div>
        <div class="form-group row p-5">
            <div class="col-md">
                <label for="{{\App\Models\Booking::CLOCK}}">CLOCK</label>
                <input type="time" name="{{\App\Models\Booking::CLOCK}}" id="{{\App\Models\Booking::CLOCK}}" required class="form-control">
            </div>
