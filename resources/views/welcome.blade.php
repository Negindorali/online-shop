...
<head>
    ...
    <link rel="stylesheet" href="{{asset('templateassets/css/animate.css')}}">

    <link rel="stylesheet" href="{{asset('templateassets/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('templateassets/css/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{asset('templateassets/css/magnific-popup.css')}}">

    <link rel="stylesheet" href="{{asset('templateassets/css/bootstrap-datepicker.css')}}">
    <link rel="stylesheet" href="{{asset('templateassets/css/jquery.timepicker.css')}}">


    <link rel="stylesheet" href="{{asset('templateassets/css/flaticon.css')}}">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="thumb d-sm-flex">
                        <a href="#" class="thumb-menu img" style="background-image: url({{asset('templateassets/images/insta-1.jpg')}});">
                        </a>
                        <a href="#" class="thumb-menu img" style="background-image: url({{asset('templateassets/images/insta-2.jpg')}});">
                        </a>
                        <a href="#" class="thumb-menu img" style="background-image: url({{asset('templateassets/images/insta-3.jpg')}});">
                        </a>
                    </div>
                    <div class="thumb d-flex">
                        <a href="#" class="thumb-menu img" style="background-image: url({{asset('templateassets/images/insta-4.jpg')}});">
                        </a>
                        <a href="#" class="thumb-menu img" style="background-image: url({{asset('templateassets/images/insta-5.jpg')}});">
                        </a>
                        <a href="#" class="thumb-menu img" style="background-image: url({{asset('templateassets/images/insta-6.jpg')}});">
                        </a>
                    </div>
                </div>
            </div>
...
<script src="{{asset('templateassets/js/jquery.min.js')}}"></script>
<script src="{{asset('templateassets/js/jquery-migrate-3.0.1.min.js')}}"></script>
<script src="{{asset('templateassets/js/popper.min.js')}}"></script>
<script src="{{asset('templateassets/js/bootstrap.min.js')}}"></script>
<script src="{{asset('templateassets/js/jquery.easing.1.3.js')}}"></script>
