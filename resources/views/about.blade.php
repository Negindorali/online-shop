...
@section('content')
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image:url({{asset('templateassets/images/bg_4.jpg')}})" data-stellar-background-ratio="0.5">
        <div class="container">
    ...
    <section class="ftco-section testimony-section" style="background-image:url({{asset('templateassets/images/bg_5.jpg')}})">
        <div class="overlay"></div>
        <div class="container">
