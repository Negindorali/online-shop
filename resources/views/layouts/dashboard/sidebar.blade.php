<div class="sidebar" id="userProfile">
    <div class="text-center p-4">
        <figure class="avatar avatar-state-success avatar-lg mb-4">
            <img src="{{asset('adminassets/media/image/avatar.jpeg')}}" class="rounded-circle" alt="image">
        </figure>
        <h4 class="text-primary m-b-10">{{auth()->user()->name}}</h4>
        <p class="text-dark d-flex align-items-center justify-content-center line-height-0 mb-0">
            {{auth()->user()->role->name}} <a href="#" class="ml-2" data-toggle="tooltip" title="تنظیمات" data-sidebar-open="#settings"> <i class="ti-settings"></i> </a>
        </p>
    </div>
    <hr class="m-0">
    <div class="p-4">
...
<div class="header">
    ...
    <div class="header-logo">
        <a href="index.html">
            <img class="large-logo" src="{{asset('adminassets/media/image/logo.png')}}" alt="image">
            <img class="small-logo" src="{{asset('adminassets/media/image/logo-sm.png')}}" alt="image">
            <img class="dark-logo" src="{{asset('adminassets/media/image/logo-dark.png')}}" alt="image">
        </a>
    </div>
    <!-- end::header logo -->
        ...
        <div class="header-body-left">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">@yield('ex-title')</li>
                </ol>
            </nav>
            <!-- end::breadcrumb -->
        </div>
        ...
        <div class="header-body-right">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                        <div class="p-4 text-center" data-backround-image="{{asset('adminassets/media/image/image1.png')}}">
